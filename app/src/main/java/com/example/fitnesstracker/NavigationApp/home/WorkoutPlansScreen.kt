...
fun WorkoutPlansScreen() {
    LazyColumn(
        ...
        item {
            WorkoutCard(
                title = "💪 Push Workout", exercises = listOf(
        ...
        item {
            WorkoutCard(
                title = "🧲 Pull Workout", exercises = listOf(
        ...
        item {
            WorkoutCard(
                title = "🦵 Leg Workout", exercises = listOf(
                    "• Squat – 3x6-10",
        ...
        item {
            WorkoutCard(
                title = "🔥 Workout A", exercises = listOf(
                    "• Squats – 3x6-8",
                    "• Bench Press – 3x6-8",
                    "• Pull-Ups – 3x8-10",
        ...
        item {
            WorkoutCard(
                title = "🔥 Workout B", exercises = listOf(
        ...
        item {
            WorkoutCard(
                title = "📅 Workout Schedule", exercises = listOf(
